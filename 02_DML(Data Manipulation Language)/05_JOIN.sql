...
SELECT mitarbeiter.Name, mitarbeiteraufgaben.Aufgabennummer
FROM mitarbeiter
         JOIN mitarbeiteraufgaben ON mitarbeiter.Mitarbeiternummer = mitarbeiteraufgaben.Mitarbeiternummer;
...
SELECT mitarbeiter.*, mitarbeiteraufgaben.Istverteilungsbetrag
FROM mitarbeiter
         LEFT JOIN mitarbeiteraufgaben ON mitarbeiter.Mitarbeiternummer = mitarbeiteraufgaben.Mitarbeiternummer;
...
SELECT mitarbeiter.*, mitarbeiteraufgaben.Istverteilungsbetrag
FROM mitarbeiter
         RIGHT JOIN mitarbeiteraufgaben ON mitarbeiter.Mitarbeiternummer = mitarbeiteraufgaben.Mitarbeiternummer;